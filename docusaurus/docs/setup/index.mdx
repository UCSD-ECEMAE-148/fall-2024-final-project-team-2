...
# Mechanics and Electronics <img src="../../static/img/car1.png" width="96" height="24" alt="El Cochito"/>
...
<img src="/static/img/wiringdiagramt2.png" width="960" height="240" alt="Wiring Diagram"/>
...
Starting with a COTS chassis from TRAXXAS has its benefits, but it needed extensive modification before it would be useful for our purposes. Stripping off the livery and decorative body of an RC truck reveals a barebones chassis like this:
 <img src="/static/img/traxxes.png" width="960" height="240" alt="Stripped TRAXXAS Slash Frame"/>
...
However, all this plastic did have a significant impact on the stance of the robot. We noticed that our ground clearance was so little that on tight turns, the bottom of our chassis would scrape the ground and we were concerned about bottoming out when driving over obstacles, so we installed new shocks designed for a much larger scale RC truck which gave us nearly 2 inches of clearance without overly affecting our roll center. The before and after is pretty shocking! (Get it??)
 <img src="/static/img/IMG_5185.jpg" width="960" height="240" alt="Old Shocks"/> <img src="/static/img/IMG_5195.jpg" width="960" height="240" alt="New Shocks"/>
