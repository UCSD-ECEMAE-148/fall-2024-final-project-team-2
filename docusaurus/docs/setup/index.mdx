...
# Mechanics and Electronics <img src="car1.png" width="96" height="24" alt="El Cochito"> </img>
...
<video src="148CARASSEMBLY.mp4" width="960" height="240" controls> </img>
...
<img src="wiringdiagramt2.png" width="960" height="240" alt="Wiring Diagram"></img>

Early on we could tell that cable management would be one of the biggest struggles we would face because packaging so many components into a relatively small chassis would usually call for custom wiring, however in most cases we were limited to the wiring harnesses provided to us by the class.
...
However, all this plastic did have a significant impact on the stance of the robot. We noticed that our ground clearance was so little that on tight turns, the bottom of our chassis would scrape the ground and we were concerned about bottoming out when driving over obstacles, so we installed new shocks designed for a much larger scale RC truck which gave us nearly 2 inches of clearance without overly affecting our roll center. The before and after is pretty shocking! (Get it??)
 <img src="IMG_5185.jpg" width="960" height="240" alt="Old Shocks"/></img> <img src="IMG_5195.jpg" width="960" height="240" alt="New Shocks"/></img>
