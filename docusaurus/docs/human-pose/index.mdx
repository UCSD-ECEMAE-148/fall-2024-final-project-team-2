...
```
This will create a list called landmark_coords that constantly display the location all landmarks detected by BlazePose. Each element is another list in the form [x, y, z].
